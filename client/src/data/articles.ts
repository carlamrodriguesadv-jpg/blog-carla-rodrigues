...
// Gerado automaticamente em 13/09/2026 08:01
...
export const articles: Article[] = [
  {
    ...
    publishedAt: "2026-09-13T08:01:13.000Z",
    authorName: "Dra. Carla Rodrigues",
    categoryName: "Defesa Criminal",
    categorySlug: "defesa-criminal",
    categoryColor: "#2D5A5A",
    tags: ["direito penal", "conjur", "direito criminal"],
    metaDescription: "Conteúdo informativo: Firmadas após 2ª guerra, bases do Direito Penal Internacional estão em xeque. Direito Criminal — Dra. Carla Rodrigues.",
